...
public class Sorts
{
  ...
  public static void printSwaps(){
      System.out.println("the swap count is: " + swapCount);
  }
  public static void printCompares(){
      System.out.println("the compare count is " + compareCount);
  }
  ...
  /////////////////////////////////////////////////////////////////
  //
  //  Quick Sort : Do not use first index as pivot point. use Midpoint instead
